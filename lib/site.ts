export const brand = {
  name: "UuuPayUuu",
  legalName: "UuuPayUuu Limited",
  tagline: "Payroll that moves",
  year: 2026,
};
...
export const company = {
  ...
  emails: {
    general: "hello@uuupayuuu.com",
    sales: "bd@uuupayuuu.com",
    care: "admin@uuupayuuu.com",
  },
};
...
export const services = [
  {
    ...
    body: "UuuPayUuu takes on the monthly payroll cycle from data intake through statutory contributions and exception handling. You send us the changes. We calculate, review, and prepare everything your finance team needs to approve with confidence.",
    points: [
  ...
  },
  {
    ...
    summary:
      "Pay your team quickly and securely through direct bank transfers or UuuPayUuu payroll cards, so people can access wages without delay.",
    body: "Once a pay run is approved, UuuPayUuu moves funds through bank transfer or payroll cards. Finance keeps a single disbursement file. Employees get a reliable payday, including teammates who do not hold a local salary account.",
    points: [
  ...
  },
  {
    ...
    body: "The UuuPayUuu employee portal puts payslips and payment history in one login. People find what they need without emailing HR. Your team spends less time on routine requests and more time on exceptions that actually need a person.",
    points: [
  ...
  },
  {
    ...
    body: "UuuPayUuu is built to grow with headcount, entities, and pay calendars. Start with a single company file. Add locations, cost centers, and pay groups when you need them. The service model stays the same, so you are not ripping out payroll every time the business steps up.",
    points: [
